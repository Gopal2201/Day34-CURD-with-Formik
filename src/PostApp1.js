                ...
                return (
                    <>
                        ...
                        <form onSubmit={handleSubmit}>
                            <div>
                                <label>User ID: </label>
                                <input type="number" name="userId" onChange={handleChange} value={values.userId}/>
                            </div>
                            <br />
                            <div>
                                <label>Title: </label>
                            ...
                            <div>
                                <label>Body: </label>
                                <input type="text" name="body" onChange={handleChange} value={values.body}/>
                            </div>
                            <br />
                            <div>
                                ...
                                {posts.map((post) => {
                                    return (
                                        <tr key={post.id}>
                                            ...
                                            <Button variant="secondary" onClick={() => {return(
                                                <>
                                                {values.id = post.id}
